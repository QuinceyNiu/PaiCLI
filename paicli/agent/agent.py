...
9. mcp__server__tool - 来自 MCP server 的第三方工具，例如 filesystem 文件操作或 zread GitHub 仓库读取
...
如果可用工具列表里出现 mcp__ 开头的工具，请根据工具描述自动选择合适的 MCP 工具；工具名格式是 mcp__server__tool，对应 MCP server.tool。
